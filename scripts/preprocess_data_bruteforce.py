...
def load_and_label_bruteforce_data(
    ...
    def map_label(label):
        ...
        if processed_label in bruteforce_labels:
            return "BruteForce"
...
def main() -> None:
    ...
    combined_df = load_and_label_bruteforce_data(cleaned_file_paths, PROCESSED_DIR)
